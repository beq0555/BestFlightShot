...
public class SpecialFlightActivity extends AppCompatActivity {
    ...
    private class SpecialInfoReceiver extends AsyncTask<Void, String, String> {
        ...
        public void onPostExecute(String result) {
            ...
            try {
                ...
                String sql = "SELECT * FROM specialdata WHERE time(time) >= time('now','localtime') AND info LIKE '%で運航%' ORDER BY time(time) LIMIT 7";
    ...
    private class ListItemClickListener implements AdapterView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent,View view,int position,long id){
            SpecialListItem item = (SpecialListItem) parent.getItemAtPosition(position);
            ...
            Intent intentNext = new Intent(SpecialFlightActivity.this,SpotActivity.class);
            ...
            //Log.i("test1","選択された機種は"+aircraftName);
